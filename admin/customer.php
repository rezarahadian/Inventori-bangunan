...
$query = "SELECT * FROM tb_customer WHERE nama_customer LIKE '%$search%' LIMIT $limit OFFSET $offset";
        ...
        <div class="modal-dialog">
            <form method="POST">
                <div class="modal-content">
                    ...
                    <div class="mb-3">
                            <label>Nama</label>
                            <input type="text" name="nama_customer" class="form-control" required placeholder="Masukan Nama">
                        </div>
                        <div class="mb-3">
                            <label>No Telepon</label>

...
$query = "SELECT * FROM tb_kategori WHERE nama_kategori LIKE '%$search%' LIMIT $limit OFFSET $offset";
                ...
                <?php
                    if ($result->num_rows > 0) {
                        ...
                        while ($row = $result->fetch_assoc()) {
                            echo "<tr>
                                <td>$no</td>
                                <td>{$row['nama_kategori']}</td> <!-- Menampilkan nama kategori -->
                                <td>
            ...
            <form method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label>Kategori</label>
                            <input type="text" name="nama_kategori" class="form-control" required placeholder="Masukan Kategori">
                        </div>
                    </div>
                    <div class="modal-footer">

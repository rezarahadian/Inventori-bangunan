...
if (isset($_POST['add_supplier'])) {
   $namasupplier = $_POST['nama_supplier'];
    ...
    $sql = "INSERT INTO tb_supplier (nama_supplier,no_telepon,alamat) VALUES ('$namasupplier','$notelepon','$alamat')";
    if ($config->query($sql)) {
...
$id_supplier = $_POST['id_supplier'];
   $namasupplier = $_POST['nama_supplier'];
    ...
    $sql = "UPDATE tb_supplier SET nama_supplier = '$namasupplier',no_telepon='$notelepon',alamat ='$alamat' WHERE id_supplier = '$id_supplier'";
    if ($config->query($sql)) {
        echo "<script>alert('Data berhasil di update'); window.location.href='supplier.php';</script>";
    } else {
...
$query = "SELECT * FROM tb_supplier WHERE nama_supplier LIKE '%$search%' LIMIT $limit OFFSET $offset";
            ...
            <form method="POST">
                <div class="modal-content">
                    ...
                    <div class="mb-3">
                            ...
                            <input type="text" name="nama_supplier" class="form-control" required placeholder="Masukan Nama">
                        </div>
                        <div class="mb-3">
                            <label>No Telepon</label>
                            <input type="text" name="no_telepon" class="form-control" required placeholder="Masukan No Telepon">
                        </div>
                        <div class="mb-3">
                            <label>Alamat</label>

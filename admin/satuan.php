...
if (isset($_POST['add_satuan'])) {
    ...
    $sql = "INSERT INTO tb_satuan (nama_satuan ) VALUES ('$namasatuan')";
    if ($config->query($sql)) {
...
if (isset($_POST['update_satuan'])) {
   $id_satuan = $_POST['id_satuan'];
    ...
    $sql = "UPDATE tb_satuan SET nama_satuan = '$namasatuan' WHERE id_satuan = '$id_satuan'";
    if ($config->query($sql)) {
        echo "<script>alert('Data berhasil di update!'); window.location.href='satuan.php';</script>";
    } else {
...
$query = "SELECT * FROM tb_satuan WHERE nama_satuan LIKE '%$search%' LIMIT $limit OFFSET $offset";
            ...
            <form method="POST">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            <label>Nama Satuan</label>
                            <input type="text" name="nama_satuan" class="form-control" required placeholder="Masukan Satuan">
                        </div>
                    </div>
                    <div class="modal-footer">

...
$(document).ready(function() {
        ...
        buttons: [
            {
                ...
                customize: function(doc) {
                    ...
                    doc.content.unshift(
                        ...
                        { text: 'Jl. Raya Utama No. 123, Kota ABC', fontSize: 12, margin: [0, 0, 0, 2], alignment: 'center' },
                        { text: 'Telp: 0812-3456-7890', fontSize: 12, margin: [0, 0, 0, 8], alignment: 'center' },
    ...
    customize: function(win) {
        ...
        $(win.document.body).prepend(
            ...
            '<div class="sub-header">Jl. Raya Utama No. 123, Kota ABC</div>' +
            '<div class="sub-header">Telp: 0812-3456-7890</div>' +
            '<div class="line"></div>'
        );
    }
}
